...
public class Action extends BaseClass {
	...
	public static boolean findElement(WebDriver webDriver, WebElement ele) {
		boolean flag = false;
		try {
			ele.isDisplayed();
			flag = true;
	...
	public static boolean isDisplayed(WebDriver webDriver, WebElement ele) {
		boolean flag = false;
		flag = findElement(webDriver, ele);
		if (flag) {
